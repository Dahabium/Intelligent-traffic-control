...
public class homePageController {
    ...
    public void createGraphbtn() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("../userinterface/createGraph.fxml"));
    ...
    public void loadGraphbtn() throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../userinterface/simulationWindow.fxml"));
